...
class word2vec:
  def __init__(self, inputfile, vocabulary_size=1200000, embedding_dim=300, epoch_num=20, batch_size=128, windows_size=5,neg_sample_num=5):
...
if __name__ == '__main__':
  wc= word2vec('../word2vec_pytorch-master/wiki_cheat.txt')
  wc.train()
